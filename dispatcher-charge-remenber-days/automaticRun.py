...
scripts = ['dispatcher-charge-remenber-days/find_charge.py', 'dispatcher-charge-remenber-days/contact_manager.py', 'dispatcher-charge-remenber-days/send_mensage.py']
