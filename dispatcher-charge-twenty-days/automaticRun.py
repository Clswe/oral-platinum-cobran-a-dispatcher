...
scripts = [
    'oral-platinum-cobran-a-dispatcher/dispatcher-charge-twenty-days/find_charge.py',
    'oral-platinum-cobran-a-dispatcher/dispatcher-charge-twenty-days/contact_manager.py',
    'oral-platinum-cobran-a-dispatcher/dispatcher-charge-twenty-days/send_mensage.py'
]
